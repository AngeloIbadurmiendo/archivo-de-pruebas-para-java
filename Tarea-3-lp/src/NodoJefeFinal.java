...
public class NodoJefeFinal extends Nodo {
    ...
    /*metodo*/
    /*Similar al nodo combate, cuando el jugador llega al nodo del jefe final comienza el combate con el 50% de probabilidad de atacar o recibir dano,
      si derrotas al jefe termina el juego con un mensaje que indica que ganaste*/
