...
public class Jugador extends Personaje {
    ...
    /*Metodos*/
    /*Obtiene las estadisticas del Personaje creado por el Jugador y luego los muestra*/
    ...
    /*Verifica que la lista tenga items, en caso de tener los imprime en pantalla (imprime la lista con el formato dado en el toString de la clase Item)*/
