...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Personaje jefe = new Personaje("Gahlran", 0, 35, 60, 10, 10);
        ...
        Personaje enemy1= new Personaje("Slime", 40, 5, 5, 2, 1);
        Personaje enemy2= new Personaje("Creeper", 55, 10, 10, 5, 2);
        Personaje enemy3= new Personaje("Slingshot", 60, 8, 8, 5, 4);
        Personaje enemy4= new Personaje("Ghost", 50, 2, 2, 3, 1);
        Personaje enemy5= new Personaje("Hunter", 200, 10, 10, 6, 5);
        ...
        // } /*Codigo de prueba para verificar nodos siguientes*/
            ...
            //             break;
            //         }else{
            //             nextNodo.add(allEncounters.get(e.y-1));
            //             //allEncounters.get(e.y-1).agregarNodo(NodoAct);
            //         }
            //     }
            // NodoAct.setSiguientes_nodos(nextNodo);  
